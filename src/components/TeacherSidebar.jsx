...
const TeacherSidebar = () =>{
    ...
    const Menus = [
        {title: "Inicio", icon: <img src={iconHome}/>, link: ""},
        {title: "Perfil", icon: <img src={iconUser}/>, link: "./Historial"},
        {title: "Crear encuesta", icon: <img src={iconAdd}/>, link: "./Historial"},
        {title: "Programar envio", icon: <img src={iconProgram} />, link: "/", isExitButton: true},
        {title: "Ver Respuestas", icon:<img src={iconCheck} />, link: "./setPerfil"},
